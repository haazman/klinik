            ...
            <form method="GET" action="{{ route('doctor.visits.index') }}" class="grid grid-cols-1 md:grid-cols-4 gap-4">
                <div>
                    ...
                    <select name="status" class="w-full rounded-md border-gray-300 shadow-sm">
                        ...
                        <option value="sedang_diperiksa" {{ request('status') == 'sedang_diperiksa' ? 'selected' : '' }}>
                ...
                <div>
                    ...
                    <input type="text" name="search" value="{{ request('search') }}"
                        placeholder="Nama atau NIK pasien..." class="w-full rounded-md border-gray-300 shadow-sm">
                </div>
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @foreach ($visits as $visit)
                                <tr
                                    class="hover:bg-gray-50 {{ $visit->status == 'sedang_diperiksa' ? 'bg-blue-50' : '' }}">
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm font-medium text-gray-900">
                                            {{ $visit->tanggal_kunjungan->format('d/m/Y') }}
                                        </div>
                                        <div class="text-sm text-gray-500">
                                            {{ \Carbon\Carbon::parse($visit->jam_kunjungan)->format('H:i') }} WIB
                                        </div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center">
                                            ...
                                            <div class="ml-3">
                                                <div class="text-sm font-medium text-gray-900">
                                                    {{ $visit->patient->nama_lengkap }}</div>
                                                <div class="text-sm text-gray-500">
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="text-sm text-gray-900">{{ Str::limit($visit->keluhan_utama, 50) }}
                                        </div>
                    ...
                    <div class="flex">
                        ...
                        <div class="ml-3">
                            ...
                            <p class="mt-1 text-sm text-blue-700">
                                {{ $nextVisit->patient->nama_lengkap }} -
                                {{ \Carbon\Carbon::parse($nextVisit->jam_kunjungan)->format('H:i') }}
                            </p>
                        </div>
                    </div>
